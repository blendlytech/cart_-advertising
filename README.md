...
A collection of prospecting resources, cold calling scripts, target market directories, and training media for grocery shopping cart advertising programs (e.g., Safeway, Save Mart).

## Project Structure

```
├── audio/
│   ├── Phone_Scr188106.amr     # Original voice recording
│   ├── Phone_Scr188106.mp3     # MP3 format for playback
...
│   └── target_categories.md                # 50+ prospective local business categories
└── photos/
    └── Resized_20250318_153759(1)138.jpeg   # Reference imagery
```
